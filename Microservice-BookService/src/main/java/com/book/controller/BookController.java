...
public class BookController {
	...
	public ResponseEntity<?> addbook(@RequestBody Book book) {
		ApiResponse resp = ApiResponse.builder().status("Success").message("Book added successfully.").result(null)
				.build();
	...
	public ResponseEntity<?> updateBookQuantity(@PathVariable("bookId") String bookId,
		...
		ApiResponse resp = ApiResponse.builder().status("Success").message("Quantity updated successfully.")
				.result(null).build();
		return new ResponseEntity<>(resp, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteBook(@PathVariable("bookId") String bookId) {
		...
		ApiResponse resp = ApiResponse.builder().status("Success").message("Book Deleted Succesfully").result(null)
				.build();
		return new ResponseEntity<>(resp, HttpStatus.OK);
	}
